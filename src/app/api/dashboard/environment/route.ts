  ...
  try {
    ...
    return NextResponse.json({
      ...
      dataSources: [
        ...
        {
          name: "BPS Climate Action Plan / GHG Inventory",
          status: "needed",
          provider: "Bureau of Planning and Sustainability",
          action: "Download Climate Action Plan and GHG inventory data from portland.gov",
        },
        {
          name: "Urban Forestry Canopy Data",
          status: "needed",
          provider: "Portland Parks & Recreation",
          action: "Download urban canopy coverage data from Portland Parks",
        },
      ],
      trend: {
